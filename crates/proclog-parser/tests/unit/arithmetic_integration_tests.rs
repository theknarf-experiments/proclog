...
use crate::{parse_program, ParseError, SrcId};
use internment::Intern;
use proclog_ast::{Literal, Program, Statement, Term};

fn parse_program_with_src(input: &str) -> Result<Program, Vec<ParseError>> {
...
fn test_parse_rule_with_comparison() {
    ...
    let result = parse_program_with_src(program_text);
